        ...
        <div class="grm__points text_fz20 text_center">
            <div class="container three">
                ...
                <div class="grm__point">
                    ...
                    <span class="text_fw500">Качественные интеграции с решениями для полиграфии собственной разработки</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="crm__abilit main__block text_fz20">
        <div class="container">
            ...
            <ul>
                ...
                <li>Интегрируйте Битрикс24 с другими нашими решениями для типографий и издательств – «1С:Полиграфия 8», «1С:Оперативная печать 8», «1С:Широкоформатная печать 8», «1С:Издательство 8», «1С:Фотоуслуги 8»</li>
            </ul>
        </div>
    </section>
    <section class="demo__banner blue short">
