        ...
        <div class="container">
            ...
            <div class="benefit__items">
                <div class="benefit__item" id="fast">
                    <img src="<?=$beforePath?>benefit/benefit1.png" alt="Быстрая поставка лицензий" class="benefit__item-image">
                    <div class="benefit__item-info text_fz18">
                        <h3 class="benefit__item-title text_fz24 text_fw600 text_upper">
                            <img src="<?=$beforePath?>benefit/benefit1.png" alt="Быстрая поставка лицензий" class="benefit__item-image">
                            Быстрая поставка лицензий
                        </h3>
                        Мы осуществляем поставку лицензий в течении 1 дня. <br>
                ...
                <div class="benefit__item" id="mark">
                    <img src="<?=$beforePath?>benefit/benefit2.png" alt="Качественная установка" class="benefit__item-image">
                    <div class="benefit__item-info text_fz18">
                        <h3 class="benefit__item-title text_fz24 text_fw600 text_upper">
                            <img src="<?=$beforePath?>benefit/benefit2.png" alt="Качественная установка" class="benefit__item-image">
                ...
                <div class="benefit__item" id="consult">
                    <img src="<?=$beforePath?>benefit/benefit3.png" alt="Квалифицированная линия консультаций" class="benefit__item-image">
                    <div class="benefit__item-info text_fz18">
                        <h3 class="benefit__item-title text_fz24 text_fw600 text_upper">
                            <img src="<?=$beforePath?>benefit/benefit3.png" alt="Квалифицированная линия консультаций" class="benefit__item-image">
                            Квалифицированная линия консультаций
                        </h3>
                        Наша компания уделяет большое внимание качеству работы службы технической поддержки и обеспечению высокого уровня обслуживания пользователей. Специалисты линии консультаций имеют практический опыт работы с программами 1С и сертификаты фирмы 1С. Они не только разрешат трудности, возникающие в процессе использования программ, но и, проанализировав пожелания по работе программных продуктов, передадут рекомендации по улучшению в отдел разработки.
                    </div>
                </div>
                <div class="benefit__item" id="garant">
                    <img src="<?=$beforePath?>benefit/benefit4.png" alt="30 дней гарантии" class="benefit__item-image">
                    <div class="benefit__item-info text_fz18">
                        <h3 class="benefit__item-title text_fz24 text_fw600 text_upper">
                            <img src="<?=$beforePath?>benefit/benefit4.png" alt="30 дней гарантии" class="benefit__item-image">
                            30 дней гарантии
                        ...
                        Наша компания имеет статусы «1С:Центр разработки», «1С:Официальный партнер», «1С: Центр ERP», «1С:Франчайзи», «Битрикс24», «1С:Консалтинг», «Победитель конкурса “Проект года”», «Сертифицированный партнер 1C-Битрикс», «Член Некоммерческого Партнерства "Поставщики Программных Продуктов" (НП ППП)», качество работ подлежит контролю со стороны фирмы «1С», которая осуществляет мониторинг качества внедрений и выборочные проверки своих партнеров.
                        <br><br>
                ...
                <div class="benefit__item" id="online">
                    <img src="<?=$beforePath?>benefit/benefit5.png" alt="Онлайн-обновления" class="benefit__item-image">
                    <div class="benefit__item-info text_fz18">
                        <h3 class="benefit__item-title text_fz24 text_fw600 text_upper">
                            <img src="<?=$beforePath?>benefit/benefit5.png" alt="Онлайн-обновления" class="benefit__item-image">
                            Онлайн-обновления
                ...
                <div class="benefit__item" id="status">
                    <img src="<?=$beforePath?>benefit/benefit6.png" alt="Подтвержденные статусы компании" class="benefit__item-image">
                    <div class="benefit__item-info text_fz18">
                        <h3 class="benefit__item-title text_fz24 text_fw600 text_upper">
                            <img src="<?=$beforePath?>benefit/benefit6.png" alt="Подтвержденные статусы компании" class="benefit__item-image">
                            Подтвержденные статусы компании
                        </h3>
                        Мы являемся постоянным партнером производителей программного обеспечения, таких как «1С», «Microsoft», Лаборатория Касперского. Компания имеет множество  подтвержденных статусов и сертификатов.
                ...
                <div class="benefit__item" id="projects">
                    <img src="<?=$beforePath?>benefit/benefit7.png" alt="1000+ выполненных проектов" class="benefit__item-image">
                    <div class="benefit__item-info text_fz18">
                        <h3 class="benefit__item-title text_fz24 text_fw600 text_upper">
                            <img src="<?=$beforePath?>benefit/benefit7.png" alt="1000+ выполненных проектов" class="benefit__item-image">
                ...
                <div class="benefit__item" id="years">
                    <img src="<?=$beforePath?>benefit/benefit8.png" alt="20 лет работы на рынке" class="benefit__item-image">
                    <div class="benefit__item-info text_fz18">
                        <h3 class="benefit__item-title text_fz24 text_fw600 text_upper">
                            <img src="<?=$beforePath?>benefit/benefit8.png" alt="20 лет работы на рынке" class="benefit__item-image">
                ...
                <div class="benefit__item">
                    <img src="<?=$beforePath?>benefit/benefit9.png" alt="+30 сертифицированных сотрудников" class="benefit__item-image">
                    <div class="benefit__item-info text_fz18">
                        <h3 class="benefit__item-title text_fz24 text_fw600 text_upper">
                            <img src="<?=$beforePath?>benefit/benefit9.png" alt="+30 сертифицированных сотрудников" class="benefit__item-image">
                ...
                <div class="benefit__item">
                    <img src="<?=$beforePath?>benefit/benefit10.png" alt="300+ реальных отзывов клиентов" class="benefit__item-image">
                    <div class="benefit__item-info text_fz18">
                        <h3 class="benefit__item-title text_fz24 text_fw600 text_upper">
                            <img src="<?=$beforePath?>benefit/benefit10.png" alt="300+ реальных отзывов клиентов" class="benefit__item-image">
                ...
                <div class="benefit__item" id="sng">
                    <img src="<?=$beforePath?>benefit/benefit11.png" alt="Работаем с партнерами из всех регионов РФ и СНГ" class="benefit__item-image">
                    <div class="benefit__item-info text_fz18">
                        <h3 class="benefit__item-title text_fz24 text_fw600 text_upper">
                            <img src="<?=$beforePath?>benefit/benefit11.png" alt="Работаем с партнерами из всех регионов РФ и СНГ" class="benefit__item-image">
                            Работаем с партнерами из всех регионов РФ и СНГ
                        </h3>
                        Компания "Армекс" работает с партнерами по всей территории Российской Федерации и стран СНГ. Мы осуществляем быструю поставку лицензий в любой населенный пункт в течении 1-го дня. Сравните наши условия поставки!
                    </div>
                </div>
            </div>
        </div>
